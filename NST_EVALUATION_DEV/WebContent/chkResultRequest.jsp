	...
	<div class="inner">
		...
		<div class="mainWrap">
			<div class="scheduleList">
				...
				<span class="titleImg"></span>
				<h2 class="titleStyle">점검의견서 초안</h2>
				<!-- 점검계획 기본정보 입력 -->
				<div  class="addCheck"style="position:absolute; top:100px!important;"><a href="chkResultSubmi.jsp" >요청</a></div>
				<!-- <div id="basicCheck">
						...
						<tbody >
							<tr>
								...
								<td>
									<table>
										<tr>
											<td><!-- <a href="chkOpinionWhit.jsp">조회</a> --></td>
										</tr>
										<tr>
											<td>조회</td>
										</tr>
										<tr>
											<td onclick="location.href='chkOpinionWhit.jsp'">조회</td>
										</tr>
										<tr>
											<td onclick="location.href='chkOpinionWhit.jsp'">조회</td>
										</tr>
