	...
	<div class="inner">
		...
		<div class="mainWrap">
			<div class="scheduleList">
				...
				<span class="titleImg"></span>
				<h2 class="titleStyle">점검의견서 작성 현황</h2>
				<!-- 점검계획 기본정보 입력 -->
				<div  class="addCheck" onclick="location.href='chkResultMain.jsp'">제출</div>
				<!-- <div id="basicCheck">
							...
							<tr>
								...
								<td>
									<table>
										...
										<tr>
											<td onclick="location.href='chkOpinionWhit.jsp'">미작성</td>
										</tr>
										<tr>
											<td>완료</td>
										</tr>
								...
								<td>
									<table>
										...
										<tr>
											<td onclick="location.href='chkOpinionModify.jsp'">확인</td>
										</tr>
										<tr>
											<td>확인</td>
										</tr>
