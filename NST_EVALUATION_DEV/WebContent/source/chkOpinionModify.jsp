	...
	<div class="inner">
		...
		<div class="mainWrap">
			<div class="scheduleList">
				...
				<h2 class="titleStyle">점검의견서 검토의견 수정</h2>
				...
				<span class="titleImg"></span>
				<h2 class="titleStyle">1차. 검토의견</h2>
				<div class="opinionBox" style="display: grid; grid-template-columns:3fr 3fr; grid-gap:20px;">
				...
				<div class="btnBox3" onclick="location.href='chkResultSubmi.jsp'">
